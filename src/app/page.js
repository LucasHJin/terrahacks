...
export default function Home() {
  return (
    <ProtectedRoute>
      <div className="min-h-screen flex items-center justify-center mobile-page-container" style={{ backgroundColor: '#f8fbfc', fontFamily: 'Inter, sans-serif' }}>
        <div className="text-center">
          <h1 className="text-5xl font-medium mb-8" style={{ color: '#071012', fontWeight: 500 }}>
            Welcome to <span style={{ color: '#f0bc67' }}>BeJacked</span>
          </h1>
