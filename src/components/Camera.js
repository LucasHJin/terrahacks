  ...
  return (
    <div className="max-w-2xl mx-auto p-6 mobile-reduced-padding" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="relative rounded-xl overflow-hidden mb-6 camera-container" 
        ...
        {isCountingDown && countdown && (
          <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
            <div className="text-8xl font-medium animate-ping drop-shadow-2xl" 
                 style={{ 
                   color: '#f8fbfc',
                   textShadow: '0 0 20px rgba(7,16,18,0.8), 0 0 40px rgba(7,16,18,0.6)',
                   fontWeight: 500,
        ...
        <div className="absolute bottom-4 left-0 right-0 flex justify-center items-center space-x-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="p-3 rounded-full shadow-lg transition-all duration-200 disabled:opacity-50"
            style={{
            ...
            onMouseLeave={(e) => {
              e.target.style.backgroundColor = '#f8fbfc';
            }}
            title="Switch Camera"
          >
      ...
      <div className="text-center">
        <div>
          <p className="font-extralight mb-2" style={{ color: '#071012', fontWeight: 200 }}>
            Point your camera at what you want to photograph and tap the capture button.
          </p>
